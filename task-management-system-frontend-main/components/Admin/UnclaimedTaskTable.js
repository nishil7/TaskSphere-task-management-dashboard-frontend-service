...
const UnclaimedTaskTable = () => {
  ...
  const fetchTasks = async () => {
    ...
    const apiUrl = 'http://localhost:8080/admin/taskManagement/resourceManagement/getAllUnclaimedTasks/1';
    try {
...
export default UnclaimedTaskTable;
